...
function ministudio_theme_customizer( $wp_customize ) {
	...
	$wp_customize->add_setting( 'ministudio_about_title' , array ( 'default' => 'Wie zijn we','sanitize_callback' => 'esc_html'));
	...
	$wp_customize->add_setting( 'ministudio_services_title' , array ( 'default' => 'Wat doen we','sanitize_callback' => 'esc_html'));
	...
	$wp_customize->add_setting( 'ministudio_pricing_title' , array ( 'default' => 'Winkel','sanitize_callback' => 'esc_html'));
	...
	$wp_customize->add_setting( 'ministudio_shop_active' , array ( 'default' => '0','sanitize_callback' => 'esc_html'));
	...
	$wp_customize->add_setting( 'ministudio_contact_title' , array ( 'default' => 'Contact','sanitize_callback' => 'esc_html'));
